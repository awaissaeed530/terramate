// Inspired by https://github.com/zereight/gitlab-mcp/blob/main/oauth.ts
...
export class GitLabOAuth {
    ...
    constructor(config: OAuthConfig) {
        ...
        this.tokenStoragePath =
            config.tokenStoragePath || join(homedir(), ".gitlab-mcp-token.json");
    }
    ...
    clearToken(): void {
        try {
            if (existsSync(this.tokenStoragePath)) {
                unlinkSync(this.tokenStoragePath);
 ...
 */
export async function initializeOAuthClient(gitlabUrl: string = "https://gitlab.com"): Promise<{
    client: GitLabOAuth;
    accessToken: string
}> {
